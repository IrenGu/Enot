...
\begin{center}
\noindent\textcolor{Green}{\syntax{(\textcolor{Black}{\textbf{ссылочка}}|\textcolor{Black}{\textbf{конст ссылочка}})\synt{простейшее_определение_типа}}}
\end{center}
...
\hspace*{11mm} \texttt{B} : \textbf{массив}\texttt{[17, 8, 19]}\textbf{вещR}\\
\\
...
\indent\synt{S}$\to$\synt{выражение}
 ...
 Оператор  \textbf{\glqq  удали\grqq }  удаляет переменные, созданные во время программы, с указанием их типов и значений. При введении \textcolor{Green}{имена переменных} удаляет только типы и значения указанных переменных. При введении \textcolor{Green}{типа переменных}, удаляет все переменные, указанного типа. При отсутствии условий все переменные, созданные во время работа программы. 
   \subsection{Оператор время}
      \begin{center}
      \syntax{
    \textcolor{Green}{оператор_время $\rightarrow$}\textbf{\glqq время вкл\grqq }
    \\
    \textcolor{Green}{оператор_время $\rightarrow$}\textbf{\glqq время выкл\grqq }
    }
 \end{center}
 ...
 \subsection{Оператор рандом}
      \begin{center}
      \syntax{
    \textcolor{Green}{оператор_рандом $\rightarrow$}\textbf{\glqq рандом\grqq }(\textcolor{Green}{промежуток})
    }
 \end{center}
...
\begin{center}
\textcolor{Green}{\syntax{[\textcolor{Black}{\texttt{+|}}\synt{имя_цикла}\textcolor{Black}{\texttt{:}}]%
\textcolor{Black}{\textbf{бесконеечно}} \textcolor{Black}{\textbf{повторяй}}\textcolor{Black}{\texttt{\{}} \{\synt{описание}|\synt{операторы}\} \textcolor{Black}{\texttt{\}}} }}
\end{center}
...
\begin{center}
\textcolor{Green}{\syntax{\textcolor{Black}{\textbf{вход}} [\textcolor{Black}{\textbf{в}} \synt{имя_цикла}]}}
\end{center}
Этот оператор совершает вход из в цикла с именем \textcolor{Green}{\syntax{\synt{имя_цикла}}}.
